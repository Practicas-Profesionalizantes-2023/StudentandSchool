...
require_once '../controllers/crud_create_correlatives.php';
require_once '../controllers/crud_views_correlatives.php';
require_once '../controllers/crud_eliminate_correlative.php';
checkSession()
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-blue navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block active">
        <a href="#" class="nav-link">Correlativas</a>
      </li>
    </ul>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Ver las Correlativas</a></li>
              <li class="breadcrumb-item active">gestion de Materia-Correlativas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <?php
    show_messages_verify('eliminate_correlative', "se elimino el registro correctamente");
    show_messages_verify('asignado_correlative', "se creo el registro correctamente");

    ?>
    <h1 class="text-center">Correlativas <?php echo $get_subject['subject_name'] ?></h1>
    <br>  
    <div class="row">
        <div class="col">
            <h4>Ver las correlativas
                <a href="#" class="btn btn-primary btn-lg correlative_Btn float-right"><i class="fas fa-plus-circle fa-lg text-white"></i></a>
            </h4>
        </div>
    </div>
    <div class="row py-5">
                ...
                <table class="table table-border small">
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="text-center">Correlativa</th>
                            <th>Eliminar</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($correlatives as $row) { ?>
                            <tr>
                                
                                <td class="text-center align-middle"><?php echo $row['details'] ?></td>
    ...
    <div class="modal-dialog modal-md modal-dialog-scrollable"> <!-- Cambia modal-md para un tamaño mediano y permite el scroll -->
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white">Crear correlatividad</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="../controllers/crud_create_correlatives.php" method="post">
                    
                    <div class="form-group">
                        <label for="subjects">Elija la materia a la que desea asignar la materia de correlatividad</label>
                        <input type="text" name=subject>
                    </div>
                    <div class="form-group">
                            <label for="subjects" class="text-white">Seleccione correlativa (Mantén presionada la tecla Ctrl para seleccionar varias)</label>
                            <select name="subjects[]" id="select_subject" class="form-control" multiple required>
                                <?php foreach ($subject_data as $row) { ?>
                                    <option value="<?php echo $row['id_subjects']; ?>"><?php echo $row['subject_name'].$show['details']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="advertencia">
                    ...
                    <form action="../controllers/crud_eliminate_correlative.php" method="post">
                        <input type="hidden" name="correlative" id="id_correlative_eliminate" value="<?php echo $get['id_correlative']; ?>">
